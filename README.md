...
## NOTE: This project is abandoned and has not been maintained since 2016.
...
* **HOPE X [Video](https://vimeo.com/101237413)**
* **Follow on [Twitter](https://twitter.com/minilockapp)** for latest project news


### Software Status
miniLock was subjected to a cryptographic code audit carried out by [Cure53](https://cure53.de/) and with the support of the [Open Technology Fund](https://www.opentechfund.org/). Quoting from the conclusion of the audit report:
